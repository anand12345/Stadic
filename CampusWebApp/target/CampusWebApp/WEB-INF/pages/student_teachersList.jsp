...
<head>
    ...
    <title>Notifications From Teacher</title>
	<!-- BOOTSTRAP STYLES-->
		...
		<div id="page-wrapper" >
			...
			<hr />
					...
					<div class="row" >
						...
						<div class="col-md-2 text-center">
						<form action="showTeacherNotifications" method="post">
								<div class="form-group">
									<input type="hidden" value="${teacher.id}" name="id"/>
									<input type="hidden" value="${teacher.name}" name="name"/>
									<input type="hidden" value="${teacher.email}" name="email"/>
									<label><button type="submit" style="border:none;background:transparent"><i class="fa fa-bullhorn fa-2x"><span class="badge">${teacher.latestCount}</span></i></button></label>
								</div>
						</form>
						</div>
					</div>
