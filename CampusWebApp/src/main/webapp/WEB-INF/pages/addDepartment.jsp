    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
			...
			<!--Add Modal Starts Here-->
				<div>
				<p class="text-center">
					<button class="btn btn-default" data-toggle="modal" data-target="#addModal">Add Department</button>
				</p>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<form id="addForm" action="addDepartment" method="post" class="form-horizontal">
			...
			<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<!-- The form is placed inside the body of modal -->
							<form:form commandName="department" id="editForm" action="editDepartment" method="post" class="form-horizontal">
								<div class="form-group">
            ...
            <c:forEach items="${departments}" var="department">
				<div class="row">
					...
					<div class="col-md-1">
						<div class="form-group">
							<button class="btn btn-default" data-toggle="modal" data-target="#editModal" onclick="onEdit(${department.id})">Edit Info</button>
						</div>
					</div>
					<div class="col-md-1">
						<div class="form-group">
							<form action="${department.id}.department" method="post">
